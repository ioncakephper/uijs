...
class UiField {
     ...
     * @param {{label, value}[]} [choices = []] - choices of label/value pairs.
     ...
     */
    render(values = {}) {
        // values = this.variables(values) // TODO: Delete this line;
     ...
     * @returns {(content: string) => string} A function that can be used to render the content of the page.
     */
    getContentRenderer() {
        let contentOptions = {
